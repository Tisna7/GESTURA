...
Route::get('/latihan-isi-1', function () {           
    return view('user.quiz-isi-1');
});
Route::get('/latihan-isi-2', function () {           
    return view('user.quiz-isi-2');
});
Route::get('/latihan-isi-3', function () {           
    return view('user.quiz-isi-3');
});
Route::get('/latihan-isi-4', function () {           
    return view('user.quiz-isi-4');
});
Route::get('/Challenge', function () {
    return view('user.challenge');
});
Route::get('/Challenge-isi-1', function () {
    return view('user.challenge-isi-1');
}); 
