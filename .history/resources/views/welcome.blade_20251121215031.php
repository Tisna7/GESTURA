...
<head>
    ...
    <title>Gestura - Platform Pembelajaran Bahasa Isyarat Interaktif</title>
    <meta name="description"
        content="Belajar bahasa isyarat Indonesia secara interaktif dengan gamifikasi, quiz, challenge mode, dan teknologi AI. Platform pembelajaran #1 di Indonesia.">
    <meta name="author" content="Gestura">
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin="">
    <link href="https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;500;600;700;800&amp;display=swap"
        rel="stylesheet">

    <meta property="og:title" content="Gestura - Platform Pembelajaran Bahasa Isyarat Interaktif">
    <meta property="og:description"
        content="Belajar bahasa isyarat Indonesia secara interaktif dengan gamifikasi, quiz, dan teknologi AI">
    <meta property="og:type" content="website">
    <meta property="og:image"
        content="https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/a74f9f8d-b91d-4dee-b1b9-1efc7e0d66e0/id-preview-a6df6d20--5823d723-8aab-44a1-a7e0-3a9140e42ab7.lovable.app-1763732964119.png">

    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:site" content="@Gestura">
    <meta name="twitter:image"
        content="https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/a74f9f8d-b91d-4dee-b1b9-1efc7e0d66e0/id-preview-a6df6d20--5823d723-8aab-44a1-a7e0-3a9140e42ab7.lovable.app-1763732964119.png">
    <script type="module" crossorigin="" src="/assets/index-i82B0bVl.js"></script>
    <link rel="stylesheet" crossorigin="" href="/assets/index-C4E6q5HX.css">
    ...
    <script defer="" src="https://gestura-sign-app.lovable.app/~flock.js"
        data-proxy-url="https://gestura-sign-app.lovable.app/~api/analytics"></script>
    <style type="text/css">
        :where(html[dir="ltr"]),
        :where([data-sonner-toaster][dir="ltr"]) {
            ...
            :where([data-sonner-toaster]) {
                ...
                transition: transform .4s ease}:where([data-sonner-toaster][data-lifted="true"]) {
                    transform: translateY(-10px)
                }

                @media (hover: none) and (pointer: coarse){:where([data-sonner-toaster][data-lifted="true"]) {
                    transform: none
                }
            }
                                                        ...
                                                        --y: translateY(calc(var(--lift) * -100%));opacity:0}:where([data-sonner-toast][data-removed="true"][data-front="false"][data-swipe-out="false"][data-expanded="true"]) {
                                                                --y: translateY(calc(var(--lift) * var(--offset) + var(--lift) * -100%));opacity:0}:where([data-sonner-toast][data-removed="true"][data-front="false"][data-swipe-out="false"][data-expanded="false"]) {
                                                                    ...
                                                                    [data-sonner-toast][data-swiping=true] {
                                                                        transform:var(--y) translateY(var(--swipe-amount-y, 0px)) translate(var(--swipe-amount-x, 0px)); transition:none
                                                                    }
                                                                    ...
                                                                    @keyframes swipe-out-left {
                                                                        0% {
                                                                            transform:var(--y) translate(var(--swipe-amount-x)); opacity:1
                                                                        }

                                                                        to {
                                                                            transform:var(--y) translate(calc(var(--swipe-amount-x) - 100%)); opacity:0
                                                                        }
                                                                    }
                                                                    ...
                                                                    @keyframes swipe-out-up {
                                                                        0% {
                                                                            transform:var(--y) translateY(var(--swipe-amount-y)); opacity:1
                                                                        }

                                                                        to {
                                                                            transform:var(--y) translateY(calc(var(--swipe-amount-y) - 100%)); opacity:0
                                                                        }
                                                                    }
                                                                    ...
                                                                    @media (max-width: 600px) {
                                                                        [data-sonner-toaster] {
                                                                            position:fixed; right:var(--mobile-offset-right); left:var(--mobile-offset-left); width:100%
                                                                        }
                                                                        ...
                                                                        [data-sonner-toaster][data-x-position=center] {
                                                                            left:var(--mobile-offset-left); right:var(--mobile-offset-right); transform:none
                                                                        }
                                                                    }
                                                                    ...
                                                                    [data-sonner-toaster][data-theme=dark] {
                                                                        --normal-bg: #000; --normal-bg-hover: hsl(0, 0%, 12%); --normal-border: hsl(0, 0%, 20%); --normal-border-hover: hsl(0, 0%, 25%); --normal-text: var(--gray1); --success-bg: hsl(150, 100%, 6%); --success-border: hsl(147, 100%, 12%); --success-text: hsl(150, 86%, 65%); --info-bg: hsl(215, 100%, 6%); --info-border: hsl(223, 100%, 12%); --info-text: hsl(216, 87%, 65%); --warning-bg: hsl(64, 100%, 6%); --warning-border: hsl(60, 100%, 12%); --warning-text: hsl(46, 87%, 65%); --error-bg: hsl(358, 76%, 10%); --error-border: hsl(357, 89%, 16%); --error-text: hsl(358, 100%, 81%)
                                                                    }

                                                                    [data-sonner-toaster][data-theme=dark] [data-sonner-toast] [data-close-button] {
                                                                        background:var(--normal-bg); border-color:var(--normal-border); color:var(--normal-text)
                                                                    }

                                                                    [data-sonner-toaster][data-theme=dark] [data-sonner-toast] [data-close-button]:hover {
                                                                        background:var(--normal-bg-hover); border-color:var(--normal-border-hover)
                                                                    }
...
<body>
        ...
        <div class="min-h-screen bg-background">
            <nav class="border-b border-border/50 backdrop-blur-lg sticky top-0 z-50">
                <div class="container mx-auto px-4 py-4 flex items-center justify-between">
                    ...
                    <div class="flex gap-3"><a href="/login"><button
                                class="inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 hover:bg-accent hover:text-accent-foreground h-11 rounded-md px-8">Masuk</button></a><a
                ...
                <div class="max-w-4xl mx-auto space-y-8">
                    <div
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            ...
                            Indonesia</span></div>
                    <h1 class="text-5xl md:text-7xl font-bold leading-tight animate-fade-in"
                        style="animation-delay: 0.1s;">Belajar Bahasa Isyarat <br><span class="text-gradient">Secara
                            Interaktif</span></h1>
                    <p class="text-xl text-muted-foreground max-w-2xl mx-auto animate-fade-in"
                        style="animation-delay: 0.2s;">Platform pembelajaran bahasa isyarat dengan teknologi AI,
                        gamifikasi, dan tantangan interaktif yang membuatmu cepat mahir.</p>
            ...
            <section class="container mx-auto px-4 py-20">
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div
                        ...
                        <p class="text-muted-foreground">Pelajari abjad, angka, imbuhan, dan kosakata lengkap dengan
                            video tutorial.</p>
                    </div>
                    <div
                        class="rounded-lg border text-card-foreground shadow-sm p-6 bg-card border-border/50 hover:border-primary/50 transition-all hover-glow cursor-pointer group">
                        ...
                        <p class="text-muted-foreground">Uji kemampuanmu dengan sistem quiz berlevel dan dapatkan
                            bintang.</p>
                    </div>
                    <div
                        class="rounded-lg border text-card-foreground shadow-sm p-6 bg-card border-border/50 hover:border-primary/50 transition-all hover-glow cursor-pointer group">
                        <div
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round"
                                class="lucide lucide-brain h-6 w-6 text-primary">
                                <path
                        ...
                        <p class="text-muted-foreground">Praktik langsung dengan AI translator untuk menerjemahkan
                            gerakanmu.</p>
                    </div>
                    <div
                        class="rounded-lg border text-card-foreground shadow-sm p-6 bg-card border-border/50 hover:border-primary/50 transition-all hover-glow cursor-pointer group">
                        <div
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round"
                                class="lucide lucide-sparkles h-6 w-6 text-primary">
                                <path
                                    d="M9.937 15.5A2 2 0 0 0 8.5 14.063l-6.135-1.582a.5.5 0 0 1 0-.962L8.5 9.936A2 2 0 0 0 9.937 8.5l1.582-6.135a.5.5 0 0 1 .963 0L14.063 8.5A2 2 0 0 0 15.5 9.937l6.135 1.581a.5.5 0 0 1 0 .964L15.5 14.063a2 2 0 0 0-1.437 1.437l-1.582 6.135a.5.5 0 0 1-.963 0z">
                                </path>
                                <path d="M20 3v4"></path>
                        ...
                        <p class="text-muted-foreground">Ikuti tantangan harian dan mingguan untuk bersaing di
                            leaderboard.</p>
                    </div>
                </div>
            </section>
            <section class="container mx-auto px-4 py-20">
                <div class="grid lg:grid-cols-2 gap-12 items-center">
                    <div class="space-y-6">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-start gap-3"><svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                </svg><span class="text-lg">Pembelajaran interaktif dengan video dan animasi</span>
                            </div>
                            <div class="flex items-start gap-3"><svg xmlns="http://www.w3.org/2000/svg"
                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                ...
                <div class="grid md:grid-cols-3 gap-6">
                    <div
                        ...
                        <div class="flex items-center gap-3 mb-4">
                            <div
                                class="h-12 w-12 rounded-full bg-primary/10 flex items-center justify-center text-2xl">
                                👨&zwj;🎓</div>
                            <div>
                        ...
                        <p class="text-muted-foreground italic">"Gestura sangat membantu saya belajar bahasa isyarat
                            dengan cepat. Sistemnya yang gamified bikin belajar jadi fun!"</p>
                    </div>
                    <div
                        class="rounded-lg border text-card-foreground shadow-sm p-6 bg-card border-border/50 hover:border-primary/50 transition-all">
                        <div class="flex items-center gap-3 mb-4">
                        ...
                        <p class="text-muted-foreground italic">"Platform yang sempurna untuk mengajar bahasa isyarat.
                            Materi lengkap dan mudah dipahami siswa."</p>
                    </div>
                    <div
                        class="rounded-lg border text-card-foreground shadow-sm p-6 bg-card border-border/50 hover:border-primary/50 transition-all">
                        <div class="flex items-center gap-3 mb-4">
            ...
            <section class="container mx-auto px-4 py-20">
                <div
                    ...
                    <p class="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">Bergabung dengan ribuan pengguna
                        lainnya dan mulai perjalanan belajar bahasa isyarat mu sekarang!</p><a href="/register"><button
                            class="inline-flex items-center justify-center gap-2 whitespace-nowrap font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 bg-primary text-primary-foreground hover:bg-primary/90 h-11 rounded-md text-lg px-8 py-6 hover-glow">Daftar
                ...
                <div class="container mx-auto px-4 py-12">
                    <div class="grid md:grid-cols-4 gap-8">
                        <div>
                            ...
                            <p class="text-sm text-muted-foreground">Platform pembelajaran bahasa isyarat interaktif
                                terbaik di Indonesia.</p>
                        </div>
                        <div>
                            <h4 class="font-bold mb-4">Tentang</h4>
                            <ul class="space-y-2 text-sm text-muted-foreground">
                                <li><a href="#" class="hover:text-primary transition-colors">Tentang Gestura</a>
                                </li>
                        ...
                        <div>
                            ...
                            <ul class="space-y-2 text-sm text-muted-foreground">
                                <li><a href="#" class="hover:text-primary transition-colors">Privacy Policy</a>
                                </li>
                                <li><a href="#" class="hover:text-primary transition-colors">Terms of
                                        Service</a></li>
                            </ul>
                        </div>
                    </div>
    ...
    <a id="lovable-badge" target="_blank"
        ...
        <span style="color: #A1A1AA;">Edit with</span> <svg width="60" height="12" viewBox="0 0 116 22"
            ...
            <defs>
                <filter id="filter0_f_19703_15608" x="-10.6577" y="-7.72354" width="38.5786" height="38.5786"
                ...
                <filter id="filter1_f_19703_15608" x="-12.9337" y="-15.0332" width="46.057" height="38.5786"
                    filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                    <feFlood flood-opacity="0" result="BackgroundImageFix"></feFlood>
                    <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape"></feBlend>
                    <feGaussianBlur stdDeviation="2.98472" result="effect1_foregroundBlur_19703_15608">
                ...
                <filter id="filter2_f_19703_15608" x="-6.41182" y="-15.9176" width="38.5786" height="35.3342"
                    filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                    <feFlood flood-opacity="0" result="BackgroundImageFix"></feFlood>
                    <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape"></feBlend>
                    <feGaussianBlur stdDeviation="2.98472" result="effect1_foregroundBlur_19703_15608">
                ...
                <filter id="filter3_f_19703_15608" x="-3.64803" y="-9.72742" width="27.9599" height="27.9599"
                    filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                    <feFlood flood-opacity="0" result="BackgroundImageFix"></feFlood>
                    <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape"></feBlend>
                    <feGaussianBlur stdDeviation="2.98472" result="effect1_foregroundBlur_19703_15608">
                ...
                <linearGradient id="paint0_linear_19703_15608" x1="6.62168" y1="4.40129" x2="12.6165"
                    y2="20.8863" gradientUnits="userSpaceOnUse">
        ...
        <button id="lovable-badge-close"
            style="position: absolute; top: -2px; right: 5px; cursor: pointer; font-size: 14px; color: #A1A1AA;">×</button>
    </a>
    <script>
