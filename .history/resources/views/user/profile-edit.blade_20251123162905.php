...
<div class="flex flex-col items-center gap-3 mb-4">
    ...
    <div class="mt-4">
    <label class="text-sm font-medium">Avatar Seed</label>
    <input type="text" name="profile_image"
        value="{{ old('profile_image', $user->profile_image) }}"
        class="border rounded w-full px-3 py-2"
        placeholder="contoh: panda, cat, ninja">
    <p class="text-xs text-muted-foreground">Ubah teks seed untuk mengganti avatar.</p>
</div>
