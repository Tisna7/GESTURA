    ...
    <div class="p-4 md:p-8">
        ...
        <div class="rounded-lg border text-card-foreground shadow-sm p-8 bg-card border-border/50">
            <div class="space-y-6">
                ...
                <div id="optionButtons" class="grid grid-cols-2 gap-4">

    <button
        class="option-btn inline-flex items-center justify-center gap-2 whitespace-nowrap font-medium
        border border-input bg-background hover:bg-accent hover:text-accent-foreground
        rounded-md px-8 h-20 text-xl">
        A
    </button>
...
<script>
    ...
    buttons.forEach(btn => {
        btn.addEventListener("click", () => {
            ...
            buttons.forEach(b => b.classList.remove("bg-accent", "text-accent-foreground"));
