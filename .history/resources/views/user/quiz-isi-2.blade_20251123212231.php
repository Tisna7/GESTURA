...
<main class="lg:ml-64 min-h-screen pt-16 lg:pt-0">
    <div class="p-4 md:p-8">
        ...
        <div class="rounded-lg border text-card-foreground shadow-sm p-4 bg-card border-border/50">
            <div class="rounded-lg border text-card-foreground shadow-sm p-4 bg-card border-border/50"><div aria-valuemax="100" aria-valuemin="0" role="progressbar" data-state="indeterminate" data-max="100" class="relative w-full overflow-hidden rounded-full bg-secondary h-2"><div data-state="indeterminate" data-max="100" class="h-full w-full flex-1 bg-primary transition-all" style="transform: translateX(-50%);"></div></div></div>
            </div>
        </div>
